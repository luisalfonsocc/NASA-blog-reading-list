...
const Footer = () => {
  return (
    <footer  className='p-0' style={{ background: 'black', padding: '20px', textAlign: 'center', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <div>

      <img className='ms-4'
          src="https://4geeksacademy.com//images/4geeksacademy-logo.png"
      ...
      <p className='me-3' style={{ color: 'white' }}>&copy; 2023 Luis Carreno</p>
    </footer>
  );
};
